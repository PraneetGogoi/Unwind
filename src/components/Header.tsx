      ...
      <div className="max-w-6xl mx-auto px-4 h-full flex items-center justify-between">
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <span className="font-display font-bold leading-none text-xl translate-y-[2px]">Unwind</span>
            <span className="font-mono text-[10px] uppercase font-bold text-grey-text">dev burnout lab</span>
          </div>
        </Link>
